# The current code unfortunately doesn't compile and remains as an attempt at solving the producer consumer problem using C++ syntax for multithreading which I'm currently unfamiliar with.
